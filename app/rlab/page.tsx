  ...
  return (
    <main>
      ...
      >
        ...
        <button
          className="absolute right-4 xl:right-32 top-2/3 -translate-y-2/3  gap-3 xl:top-1/2 xl:-translate-y-1/2 p-2  text-white/8 rounded flex items-center transition-transform duration-300"
