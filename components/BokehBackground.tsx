...
const BokehBackground: React.FC = () => {
      ...
      const sketch = (p: p5) => {
        class Bubble {
          ...
          show() {
            ...
            p.drawingContext.shadowColor = `rgba(${r}, ${g}, ${b}, 0.9)`;
        ...
        const numBubbles = p.windowWidth < 768 ? 12 : 20; // Menos burbujas en pantallas pequeñas
  ...
  return <div ref={sketchRef} className="absolute top-0 filter blur-md inset-0" />;
};
